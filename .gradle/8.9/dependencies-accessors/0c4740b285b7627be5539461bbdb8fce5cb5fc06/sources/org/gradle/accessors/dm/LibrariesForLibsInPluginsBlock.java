...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final NapierLibraryAccessors laccForNapierLibraryAccessors = new NapierLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>napier</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public NapierLibraryAccessors getNapier() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForNapierLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class NapierLibraryAccessors extends SubDependencyFactory {
        private final NapierAndroidLibraryAccessors laccForNapierAndroidLibraryAccessors = new NapierAndroidLibraryAccessors(owner);

        public NapierLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>logging</b> with <b>io.github.aakira:napier</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getLogging() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("napier.logging");
        }

        /**
         * Group of libraries at <b>napier.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NapierAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNapierAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NapierAndroidLibraryAccessors extends SubDependencyFactory {

        public NapierAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>debug</b> with <b>io.github.aakira:napier-android-debug</b> coordinates and
         * with version reference <b>napierAndroidDebug</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getDebug() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("napier.android.debug");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>napierAndroidDebug</b> with value <b>2.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNapierAndroidDebug() { return getVersion("napierAndroidDebug"); }
