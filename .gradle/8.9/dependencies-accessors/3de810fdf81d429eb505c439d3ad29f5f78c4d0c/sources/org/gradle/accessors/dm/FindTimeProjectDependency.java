...
@NonNullApi
public class FindTimeProjectDependency extends DelegatingProjectDependency {

    @Inject
    public FindTimeProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
